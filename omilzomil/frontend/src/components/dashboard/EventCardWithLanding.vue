<template>
  <div class="card">
    ...
    <div class="textbox">
      <div class="text1">
        {{ (photo == 1) ? '계룡대근무지원단 본부대대':'김민섭' }}
      </div>
      <div class="text2">
        {{ (photo == 1) ? '전체 부대 중 외적 군기 1등을 축하합니다.':'이번 달 소속 부대의 으뜸 병사입니다!' }}
      </div>
    </div> 
    <div
      v-if="photo==1"
  ...
  .overlay{
    ...
    z-index:1000000;
      ...
      @keyframes slide-tr {
          0% {
              transform-origin: 0% 100%;
              transform: scale(0.2) translateY(80px) translateX(-60%);
          }
          100% {
              transform-origin: 100% 100%;
      ...
      @keyframes slide-right {
          0% {
              ...
              transform: scaleX(0.3) translateY(40px) translateX(-80px);
          }
          100% {
              transform-origin: 0% 0%;
              transform: scaleX(1.0) translateY(0) translateX(0px);
          }
      }
      @keyframes ball {
          0% {
      ...
      .card .image .three{
          ...
          top: 6.5%;
          bottom: 58.82%;
          animation: slide-tr 0.7s cubic-bezier(0.250, 0.460, 0.450, 0.940) both;
      }
      .card .image .four{
          position: absolute;
          left: 61.5%;
      ...
      .card .image .five{
          ...
          top: 21.58%;
          bottom: 70.9%;
          animation: ball 1s cubic-bezier(0.250, 0.460, 0.450, 0.940) both;
      }
      .card .image .six{
          position: absolute;
          left: 40.17%;
