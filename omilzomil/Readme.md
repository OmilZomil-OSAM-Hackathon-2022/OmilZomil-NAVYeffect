...
gif
 + OMIL-ZOMIL을 사용하기 위해 기본적으로 제공하는 로그인, 회원 가입 기능입니다. *회원 가입 신청 시 부대 관리자의 승인이 필요합니다.*
...
gif
 + 프로필 수정 탭 외에도 휴가 관리 탭이 추가되었습니다.
 + !!!!이거 휴가 관리로 취소 가능했던 듯.... 퇴근 후 페이지 다시 보고 필요 시 개발진 문의 필요!!!!
